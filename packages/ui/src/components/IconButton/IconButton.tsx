...
const sizeStyles = (t: DefaultTheme): Record<IconButtonSize, ReturnType<typeof css>> => ({
...
const variantStyles = (t: DefaultTheme): Record<IconButtonVariant, ReturnType<typeof css>> => ({
  primary: css`
...
const Root = styled.button<{ $variant: IconButtonVariant; $size: IconButtonSize; $fullWidth: boolean }>`
  display: inline-flex;
  align-items: center;
